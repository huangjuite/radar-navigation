...
# [x,y,z,x,y,z,w]
INITIAL_STATES = [[6, 21.317, 0.16439, 0, 0, 0.84, -0.52],
                  [-7.1, 21.894, 0.16439, 0, 0, 0.78, -0.6],
                  [-8.12, 4.852, 0.16439, 0, 0, 0.15, -0.98],
                  [-6.5, -12, 0.16439, 0, 0, 0.28, -0.95],
                  [-6, -25, 0.16439, 0, 0, 0.05, -0.998],
                  [6.5, -24.4, 0.16439, 0, 0, -0.751, -0.6602],
                  [6.5, -10, 0.16439, 0, 0, -0.987, -0.159],
                  [6.5, 12.55, 0.16439, 0, 0, -0.6, -0.7],
                  [6.5,20.08, 0.16439 , 0, 0, -0.6, -0.7]]


class SubtUrbanEnv(gym.Env):
    ...
    def get_observation(self):
        ...
        while data1 is None or data2 is None:
            try:
                data1 = rospy.wait_for_message('/RL/scan/upper', LaserScan, timeout=5)
                data2 = rospy.wait_for_message('/RL/scan/lower', LaserScan, timeout=5)
            except:
                pass
